var throwable_base = {
		...
		initUserArea : function(userId, userName, num) {
			...
			str += '<li role="presentation" class="dropdown-header" style="color:white"><a href="">消息中心 <span id="notice_num_area" class="badge">'+num+'</span></a></li>';
